                ...
                <tbody class="divide-y divide-white/10">
                    ...
                    <tr class="vlinha hover:bg-white/5 {{ $c->atrasado ? 'bg-red-500/10' : '' }}"
                        ...
                        <td class="px-3 py-2 text-center">
                            @if($c->status_tipo === 'aguardando')
                                {{-- Sem parcelas pagas ainda: icone estatico, sem acao --}}
                                <span class="text-gray-600 select-none" aria-hidden="true">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" class="w-5 h-5 inline"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/></svg>
                                </span>
                            @else
