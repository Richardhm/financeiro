            ...
            <section style="display:flex;flex-basis:24%;justify-content: space-between;">
                <div style="display:flex;flex-basis:48%;flex-direction:column;">
                    ...
                    <div style="margin-top:2px;margin-bottom:2px;" class="bg-[rgba(254,254,254,0.18)] backdrop-blur-[15px]">
                        <p style="color:white;border-bottom:1px solid white;margin:0;padding: 0;display:flex;">
                            <span style="flex-basis:90%;justify-content:center;display:flex;font-size:0.7em;">
                                <span>Planos</span>

                            </span>
                            <div style="flex-basis:10%;font-size:0.7em;">
                ...
                <div style="display:flex;flex-basis:48%;flex-direction:column;">
                    ...
                    <div style="margin-top:2px;" class="bg-[rgba(254,254,254,0.18)] backdrop-blur-[15px]">
                        <span style="justify-content:center;display:flex;font-size:0.7em;color:white;border-bottom:1px solid white;">Planos
            ...
            function exportAllToExcel(mes,ano) {
                ...
                Promise.all(urls.map(url => fetch(url).then(res => res.json())))
                    .then(dataArrays => {
                        ...
                        const headers = ["Cod.Externo","Data","Cliente","Valor","Vidas","Corretor","Plano","Parcela","Administradora"];
...
// Evento do botão removeButton
            ...
            $("body").on('click', '.pagar_comissao_up', function () {
                ...
                const descontoInput = linha.find("input[name='porcentagem_change']").val();
                const desconto = descontoInput
                    ? parseFloat(descontoInput.replace(/\./g, '').replace(',', '.'))
                    : 0;
...
@section('css')
    <style>
        ...
        table.modal_empresarial_tabela_gerente thead th {
            font-size: 1.2em !important;
        }

        table.modal_empresarial_tabela_gerente tbody td {
            font-size: 1.2em !important;
        }
