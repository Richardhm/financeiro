<div id="uploadModal" class="fixed inset-0 flex items-center justify-center z-[9999] hidden bg-black/60">
    <div class="w-full max-w-md mx-4 rounded-xl overflow-hidden shadow-2xl" style="background:#1e1e1e;border:1px solid #2a3d55;">
        <div class="flex items-center justify-between px-5 py-3" style="background:#0e1a28;border-bottom:1px solid #2a3d55;">
            <h5 class="text-xs font-bold uppercase tracking-widest" style="color:#e0e0e0;">Upload Cadastro Individual</h5>
            <button type="button" class="close-modal-upload text-2xl font-bold leading-none transition" style="color:#888;" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='#888'">&times;</button>
        </div>
        <div class="px-5 py-5">
