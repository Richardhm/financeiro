            ...
            <fieldset class="fin-fieldset">
                ...
                <div class="fin-filters-group">
                    @if(auth()->user()->can('listar_todos'))
                        <select id="select_corretoras" class="fin-select" style="display:none">
            ...
            <fieldset class="fin-fieldset">
                ...
                <div class="fin-status-group">
                    ...
                    <ul id="listar_individual" class="fin-stats-group list-none m-0 p-0">
                        <li class="fin-stat fin-p1 individual" id="aguardando_pagamento_1_parcela_individual">1ª Parc. <b class="individual_quantidade_1_parcela">0</b></li>
                        <li class="fin-stat fin-p2 individual" id="aguardando_pagamento_2_parcela_individual">2ª Parc. <b class="individual_quantidade_2_parcela">0</b></li>
                        <li class="fin-stat fin-p3 individual" id="aguardando_pagamento_3_parcela_individual">3ª Parc. <b class="individual_quantidade_3_parcela">0</b></li>
                        <li class="fin-stat fin-p4 individual" id="aguardando_pagamento_4_parcela_individual">4ª Parc. <b class="individual_quantidade_4_parcela">0</b></li>
                        <li class="fin-stat fin-p5 individual" id="aguardando_pagamento_5_parcela_individual">5ª Parc. <b class="individual_quantidade_5_parcela">0</b></li>
                    </ul>
