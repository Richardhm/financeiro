    ...
    <div class="w-full max-w-md mx-4 rounded-xl overflow-hidden shadow-2xl" style="background:#1e1e1e;border:1px solid #2a3d55;">
        ...
        <div class="px-5 py-5">
            <form action="" method="POST" name="formulario_atualizar_empresarial" id="formulario_atualizar_empresarial" enctype="multipart/form-data">
                @csrf
                <label for="arquivo_atualizar_empresarial" class="block text-[10px] font-bold uppercase tracking-widest mb-2" style="color:#3d7ab5;">Planilha de baixas (.xlsx)</label>
                <input type="file" accept=".xlsx" name="arquivo_atualizar_empresarial" id="arquivo_atualizar_empresarial" class="block w-full text-sm rounded-lg px-3 py-2 cursor-pointer" style="background:#141414;border:1px solid #2a3d55;color:#e0e0e0;">
                <p class="text-[10px] mt-2" style="color:#888;">Para cadastrar um <b>contrato em PDF</b>, use o botão <b>"Cadastrar via PDF"</b> na aba Empresarial.</p>
            </form>
        </div>
    </div>
</div>
