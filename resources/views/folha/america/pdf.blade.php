        ...
        <div class="corretor-section">
            ...
            <table>
                ...
                <tr>
                    ...
                    <th>Estorno</th>
                    <th>Desconto</th>
                    @if(($dadosCorretor['totais_tipos']['vale'] ?? 0) > 0)
                    <th style="color:#b71c1c">Vale (−)</th>
                    @endif
                    @if(($dadosCorretor['totais_tipos']['fixo'] ?? 0) > 0)
                    <th style="color:#b71c1c">Fixo (−)</th>
                    @endif
                </tr>
                </thead>
                <tbody>
                <tr>
                    ...
                    @if(($dadosCorretor['totais_tipos']['vale'] ?? 0) > 0)
                    <td class="valor" style="color:#b71c1c">R$ {{ number_format($dadosCorretor['totais_tipos']['vale'], 2, ',', '.') }}</td>
                    @endif
                    @if(($dadosCorretor['totais_tipos']['fixo'] ?? 0) > 0)
                    <td class="valor" style="color:#b71c1c">R$ {{ number_format($dadosCorretor['totais_tipos']['fixo'], 2, ',', '.') }}</td>
                    @endif
                </tr>
                </tbody>
            </table>
