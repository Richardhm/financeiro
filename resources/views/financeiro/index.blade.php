<x-app-layout>
    ...
    <input type="hidden" id="janela_atual" value="aba_individual">
        ...
        <script>
            ...
            var urlProgressoSincronizacao = "{{ route('financeiro.sincronizar.progresso', ['jobId' => '__JOB__']) }}";
            ...
            <div class="w-full max-w-md mx-4 rounded-xl overflow-hidden shadow-2xl" style="background:#1e1e1e;border:1px solid #2a3d55;">
                ...
                <div class="px-5 py-5">
                    <form action="" method="POST" name="formulario_cancelados" id="formulario_cancelados" enctype="multipart/form-data">
                        ...
                        <input type="file" accept=".xlsx" name="arquivo_cancelados" id="arquivo_cancelados" class="block w-full text-sm rounded-lg px-3 py-2 cursor-pointer" style="background:#141414;border:1px solid #2a3d55;color:#e0e0e0;">
                    </form>
                </div>
            </div>
        </div>
