<x-app-layout>
    ...
    <div id="modalEstorno" class="fixed inset-0 flex items-center justify-center z-[9999] hidden bg-black/60">
        ...
        {{-- Barra de configurações de comissão --}}
        <div style="width:95%;margin:0 auto 8px auto;">
            <div style="display:flex;align-items:center;gap:6px;flex-wrap:wrap;padding:6px 10px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);border-radius:8px;">
                <span style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.08em;color:#9ca3af;margin-right:4px;">Config. Comissões</span>

                <a href="{{ route('folha.america.template-comissoes') }}"
                   class="fin-btn"
                   style="background:#0369a1;text-decoration:none;font-size:11px;padding:3px 10px;">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="fin-btn-icon" style="width:13px;height:13px;">
                ...
                <a href="{{ route('folha.america.faixas-clt') }}"
                   class="fin-btn"
                   style="background:#166534;text-decoration:none;font-size:11px;padding:3px 10px;">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="fin-btn-icon" style="width:13px;height:13px;">
                ...
                <a href="{{ route('folha.america.regras-pj') }}"
                   class="fin-btn"
                   style="background:#1e3a5f;text-decoration:none;font-size:11px;padding:3px 10px;">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="fin-btn-icon" style="width:13px;height:13px;">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 0 1 3 19.875v-6.75ZM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V8.625ZM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V4.125Z" />
                    </svg>
                    Regras PJ
                ...
                <a href="{{ route('folha.america.comissao-corretora') }}"
                   class="fin-btn"
                   style="background:#7c2d12;text-decoration:none;font-size:11px;padding:3px 10px;">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="fin-btn-icon" style="width:13px;height:13px;">
