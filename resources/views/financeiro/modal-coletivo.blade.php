            ...
            <tbody>
                ...
                <tr class="{{ $analiseFeita ? 'fim-tr-paid' : '' }}">
                    ...
                    <td style="text-align:center">
                        <svg xmlns="http://www.w3.org/2000/svg" data-id="{{ $id }}" data-fase="1" viewBox="0 0 24 24" fill="currentColor" id="desfazer_1" class="desfazer_individual">
                ...
                <tr class="{{ $emissaoFeita ? 'fim-tr-paid' : '' }}">
                    ...
                    <td style="text-align:center">
                        <svg xmlns="http://www.w3.org/2000/svg" data-id="{{ $id }}" data-fase="2" viewBox="0 0 24 24" fill="currentColor" id="desfazer_2" class="desfazer_individual">
                            <path fill-rule="evenodd" d="M9.53 2.47a.75.75 0 0 1 0 1.06L4.81 8.25H15a6.75 6.75 0 0 1 0 13.5h-3a.75.75 0 0 1 0-1.5h3a5.25 5.25 0 1 0 0-10.5H4.81l4.72 4.72a.75.75 0 1 1-1.06 1.06l-6-6a.75.75 0 0 1 0-1.06l6-6a.75.75 0 0 1 1.06 0Z" clip-rule="evenodd" />
                        </svg>
                    </td>
                </tr>
                ...
                @foreach($dados->comissao->comissoesLancadas as $kk => $cr)
                    ...
                    <tr class="{{ $trCls }}">
                        ...
                        <td style="text-align:center">
                            <svg xmlns="http://www.w3.org/2000/svg" data-fase="{{ $fase }}" data-id="{{ $id }}" viewBox="0 0 24 24" fill="currentColor" id="desfazer_{{ $kk+3 }}" class="desfazer_individual">
                                <path fill-rule="evenodd" d="M9.53 2.47a.75.75 0 0 1 0 1.06L4.81 8.25H15a6.75 6.75 0 0 1 0 13.5h-3a.75.75 0 0 1 0-1.5h3a5.25 5.25 0 1 0 0-10.5H4.81l4.72 4.72a.75.75 0 1 1-1.06 1.06l-6-6a.75.75 0 0 1 0-1.06l6-6a.75.75 0 0 1 1.06 0Z" clip-rule="evenodd" />
                            </svg>
                        </td>
                    </tr>
