<x-app-layout>
    ...
    @section('css')
        <style>
            /* Melhora a experiência de toque no iOS */
            input[type="radio"] {
                width: 20px;
                height: 20px;
            ...
            .ios-device .container_image_operadora,
            .ios-device .plano-container {
                margin-bottom: 8px;
            }
    ...
    @section('scripts')
       <script>
           $(document).ready(function(){
               ...
               // Adicione este código ao seu $(document).ready()
               function melhorarAreaDeClique() {
                   // Aumenta a área de clique para inputs radio
                   $('label').css('cursor', 'pointer');

                   // Faz com que o clique no label também acione o input
               ...
               melhorarAreaDeClique();

               // Evita problemas de propagação de eventos no iOS
               $("body").on('touchstart', '.container_image_operadora, .plano-container', function(e) {
                   const radio = $(this).find('input[type="radio"]');
                   if (radio.length && !$(e.target).is(radio)) {
                       e.preventDefault();
               ...
               function detectarDispositivo() {
                   ...
                   if (isIOS) {
                       ...
                       // Melhora o comportamento de scroll no iOS
                       $('html, body').css({
               ...
               $("body").on('click touchstart', "input[name='operadoras'], input[name='planos-radio'], input[name='tipo_cotacao'], input[name='tipo_cotacao_ambulatorial']", function(e) {
                   // Pequeno atraso para garantir que o iOS processe o evento
                   setTimeout(() => {
                       ...
                       // Se for um radio de operadoras
                       if ($(this).attr('name') === 'operadoras') {
                           let valor = $(this).val();
